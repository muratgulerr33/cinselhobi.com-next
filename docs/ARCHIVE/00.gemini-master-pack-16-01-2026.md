...
- [DOC-14: 14.gemini-bridge-instructions.md](#doc-14)
...
**Evidence:** `src/components/hub/category-bubble-rail.tsx` (lines 77-125: chip/pill UI), `src/components/hub/category-quick-look-sheet.tsx` (lines 45-92: lazy fetch), `src/app/hub/[hubSlug]/page.tsx` (lines 57-100: hero section)
...
<a id="doc-14"></a>
# DOC-14: 14.gemini-bridge-instructions.md
...
#### What we locked
- Hub intent guardrail kuralları: Manken ürünleri `et-dokulu-urunler` kategorisinde bulunamaz
...
- Exception eklemek için `locks/guardrail-exceptions.json` kullanılır
...
#### Expected outputs (paste from evidence pack)
- `fantezi-aksesuarlar` (0 ürün) → UI'da gizli
- `sex-makineleri` (0 ürün) → UI'da gizli
