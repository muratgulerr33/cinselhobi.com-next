...
ŞİRKET
ADI/UNVANI: TARIK BENER EROSHOP
ADRES: HAMİDİYE MAHALLESİ CENGİZ TOPEL CADDESİ REFAH APARTMANI ALTI NO:11/B AKDENİZ/MERSİN
EPOSTA: info@demo.cinselhobi.com, tarikbener@gmail.com
TEL:(0324) 999 21 33
...
Websitesi üzerinden yapılan alışverişlerde değişim yapılamamakta sadece iade işlemi yapılmaktadır.

ALICI, sözleşme konusu ürünün kendisine veya gösterdiği adresteki kişi/kuruluşa tesliminden itibaren 14 (ondört) gün içinde hiçbir hukuki ve cezai sorumluluk üstlenmeksizin ve hiçbir gerekçe göstermeksizin mal/hizmetin kullanılmamış/hasar görmemiş/eksiksiz olması şartıyla sadece iade yapma hakkına sahiptir. İade yapma hakkının kullanılması için SATICI'ya yapılacak olan iade talebi bildirimi, malın tesliminden itibaren 7 (yedi) günlük süre içinde Mesafeli Satış Sözleşmelerine Dair Yönetmelik gereğince ALICI tarafından, e-mail yoluyla yapılmalıdır. O nedenle SATICI'dan e-mail aracılığıyla iade talep etmelidir. İade kargolarında kargo bedeli ALICI'ya aittir.

Ürün iade talebi bildirimi akabindeki en geç 7 (yedi) gün içerisinde ALICI anlaşmalı kargo aracılığı ile SATICI'ya ulaştırılmış olmalıdır. Aksi halde ALICI iade talebinden feragat etmiş sayılacaktır.

 

İade ürünü teslim alan SATICI gerekli kontrolleri sağladıktan sonra anlaşmalı kargo bedelini ürün bedelinden düşerek ALICI'ya iade etmekle yükümlüdür.

Kısmı iadelerde ücretsiz kargo hakkından faydalanan ALICI'nın iade sonrası alışveriş tutarı ücretsiz kargo limiti altında kalıyorsa kendisinden gidiş kargo bedeli de düşülerek iadesi sağlanacaktır.
...
İade edilecek ürün(ler) sadece YURTİÇİ KARGO 982-383-216 kodu ile SATICI'ya ulaştırılır.

Farklı bir kargo şirketi kullanmak isteyen ALICI, gönderim masrafını üstlenmek durumundadır.

 

CAYMA HAKKI KULLANILAMAYACAK ÜRÜNLER:
21.ALICI'nın isteği veya açıkça kişisel ihtiyaçları doğrultusunda hazırlanan ve geri gönderilmeye müsait olmayan, iç giyim alt parçaları, mayo ve bikini altları, makyaj malzemeleri, tek kullanımlık ürünler, çabuk bozulma tehlikesi olan veya son kullanma tarihi geçme ihtimali olan mallar, ALICI'ya teslim edilmesinin ardından ALICI tarafından ambalajı açıldığı takdirde iade edilmesi sağlık ve hijyen açısından uygun olmayan ürünler, teslim
...
ÖDEME VE TESLİMAT
AKBANK / TARIK BENER / TR70 0004 6003 6288 8000 2725 56

25.Sitemiz üzerinden kredi kartlarınız ile, Her türlü kredi kartınıza online tek ödeme ya da anlaşmalı bankalarımız ile online taksit imkânlarından yararlanabilirsiniz. Online ödemelerinizde siparişiniz sonunda kredi kartınızdan tutar çekim işlemi gerçekleşecektir.`;
