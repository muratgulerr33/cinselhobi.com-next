...
export function ProductGallery({
  ...
  return (
    <div className="relative h-[clamp(320px,55vh,620px)] w-full max-w-full min-w-0 bg-gray-50">
      <div
        ref={scrollerRef}
        onScroll={handleScroll}
        className="relative w-full max-w-full min-w-0 h-full overflow-x-auto overscroll-x-contain scroll-smooth snap-x snap-mandatory no-scrollbar touch-pan-x"
      >
