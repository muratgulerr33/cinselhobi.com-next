...
export const footerLinks: FooterLinkGroup[] = [
  ...
  },
  {
    title: "Kategoriler",
    links: [
      { label: "Kadınlara Özel", href: "/kadinlara-ozel" },
      { label: "Erkeklere Özel", href: "/erkeklere-ozel" },
      { label: "Vibratörler", href: "/modern-vibratorler" },
      { label: "Kayganlaştırıcılar", href: "/kayganlastirici-jeller" },
